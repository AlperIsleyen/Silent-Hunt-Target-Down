...
void SpawnNPCs(List<Transform> spawnPoints)
{
    ...
    void FindClothing()
    {
        ...
        IEnumerator wait()
        {
            ...
            int upper_cloth = target.GetComponent<clothing>().upper_cloth;
            ...
            if (skin == 0 || skin == 1) { Skin = "Dark Skinned"; }
            else if (skin >= 2) { Skin = "Light Skinned"; }

            if (hair == 0) { Hair = "Dark"; }
            else if (hair == 1) { Hair = "Brown"; }
            else if (hair == 2) { Hair = "Blonde"; }
            ...
            //
            if (glass == true){Glasses = "Has Glasses";}
            //
            if (scraf == true){Scarf = "Has Scarf";}  
            //
            if (chani == true){Chain = "Has Chain";}
            //
            if (sex == 0) {Gender = "Boy";} 
            else{Gender = "Girl";}
            //
